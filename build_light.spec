...
a = Analysis(
    ...
    excludes=[
        # Large libs — loaded from system Python
        "torch", "torchvision", "nvvfx", "nvvfx._ext",
        "nvvfx.effects", "nvvfx.effects.video_super_res", "nvvfx.effects.base",
        "cv2", "cv2.cv2",
        "onnx",
        # Unused
